...
<body>
        ...
        <?php if (isset($name)): ?>
            <div class="product-details">
                <div class="image-container">
                    <img src="data:image/jpeg;base64,<?php echo base64_encode($image); ?>" alt="Product Image">
                </div>
    ...
    <div class="button-container">
        <?php if (isset($name)): ?>
            <a href="my_trades.php" class="button button-green">Back to Products</a>
            <?php if ($status == 'Available'): ?>
                <form action="update_status.php" method="post">
                    <input type="hidden" name="product_id" value="<?php echo $product_id; ?>">
                    <button type="submit" class="button button-red">Update Status to Sold Out</button>
                </form>
            <?php endif; ?>
        <?php endif; ?>
    </div>
